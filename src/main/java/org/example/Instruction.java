...
public class Instruction extends JPanel {
    public Instruction(JFrame frame) {
        ...
        JLabel insructionLabel = new JLabel("Anleitung");
        insructionLabel.setFont(new Font("Arial BLACK", Font.BOLD, 78));
        insructionLabel.setForeground(Color.WHITE);
        insructionLabel.setAlignmentX(Component.CENTER_ALIGNMENT);


        JLabel registerLabel = new JLabel(" intruction...");
        ...
        roundedPanel.add(insructionLabel);
